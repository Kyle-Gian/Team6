...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Recall Hammer"",
                    ""type"": ""Button"",
                    ""id"": ""490a2736-8470-45a0-b419-18cdbb911dc4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""SummonLightning"",
                    ""type"": ""Value"",
                    ""id"": ""f66215ee-b74c-4940-bab6-d1519fba6232"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""a65847af-71d0-47ed-8eaa-e155ec85a0fe"",
                    ""path"": ""<XRController>{LeftHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""Recall Hammer"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""ef273301-739a-4139-91c0-a6e130c3833d"",
                    ""path"": ""<XRController>{LeftHand}/triggerPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""SummonLightning"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""668f3fdf-8e74-4d42-bf60-2f2dc07912f9"",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Recall Hammer"",
                    ""type"": ""Button"",
                    ""id"": ""9a874bdb-4d80-434c-8e02-189409f96afa"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""2c906bb2-eb97-4e20-8783-c2b63668d4b7"",
                    ""path"": ""<XRController>{RightHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_RecallHammer = m_XRILeftHand.FindAction("Recall Hammer", throwIfNotFound: true);
        m_XRILeftHand_SummonLightning = m_XRILeftHand.FindAction("SummonLightning", throwIfNotFound: true);
        // XRI RightHand
        ...
        m_XRIRightHand_RecallHammer = m_XRIRightHand.FindAction("Recall Hammer", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRILeftHand_RecallHammer;
    private readonly InputAction m_XRILeftHand_SummonLightning;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @RecallHammer => m_Wrapper.m_XRILeftHand_RecallHammer;
        public InputAction @SummonLightning => m_Wrapper.m_XRILeftHand_SummonLightning;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @RecallHammer.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnRecallHammer;
                @RecallHammer.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnRecallHammer;
                @RecallHammer.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnRecallHammer;
                @SummonLightning.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSummonLightning;
                @SummonLightning.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSummonLightning;
                @SummonLightning.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnSummonLightning;
            }
            ...
            if (instance != null)
            {
                ...
                @RecallHammer.started += instance.OnRecallHammer;
                @RecallHammer.performed += instance.OnRecallHammer;
                @RecallHammer.canceled += instance.OnRecallHammer;
                @SummonLightning.started += instance.OnSummonLightning;
                @SummonLightning.performed += instance.OnSummonLightning;
                @SummonLightning.canceled += instance.OnSummonLightning;
            }
        }
    }
    ...
    private readonly InputAction m_XRIRightHand_RecallHammer;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @RecallHammer => m_Wrapper.m_XRIRightHand_RecallHammer;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @RecallHammer.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRecallHammer;
                @RecallHammer.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRecallHammer;
                @RecallHammer.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRecallHammer;
            }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnRecallHammer(InputAction.CallbackContext context);
        void OnSummonLightning(InputAction.CallbackContext context);
    }
